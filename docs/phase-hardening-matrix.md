...
| Replacement candidate | Same-lineage candidate cites `supersedes`, every rejection, every candidate Review failure, current simplification, and preserves unaffected evidence | `complete-superseding-intent-candidates-for@1` | Autonomous candidate correction; the Assignment explicitly binds the current passing simplification REV | Fresh candidate Review **Assignment** | Candidate Review budget applies | Rejection history remains non-approval evidence |
