...
| Question Decision correction exhausts | Current Decision still fails after two causal replacements | `question-decision-review-escalation-required@1` | Attended `escalate-question-decision-review-correction@1` | Immediate **Attention Required** with complete lineage | 2 consumed; exhausted | No answer, deferral, or cancellation becomes applicable without a fresh passing Review |
...
| Gate Decision correction exhausts | Current gate DEC still fails after two causal replacements | `gate-signoff-review-escalation-required@1` | Attended `escalate-gate-signoff-review-correction@1` | Immediate **Attention Required** with exhaustion reason | 2 consumed; exhausted | Candidate scope cannot change inside Decision correction |
