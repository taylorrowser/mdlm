...
| --- | --- |
| Fresh initialization and exact selection | `mdlm init` records `mdlm-bootstrap@0.63.0` without a package flag or descriptor edit; the onboarding test asserts the exact package and clean setup commit. |
