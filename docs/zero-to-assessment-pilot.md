...
| --- | --- |
| Fresh initialization and exact selection | Canonical package and initialization checks protect exact package selection. The onboarding transaction test protects the clean setup commit and subsequent public transaction. |
