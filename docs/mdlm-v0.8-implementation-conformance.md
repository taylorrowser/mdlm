...
- **Implementation package:** `mdlm-bootstrap@0.37.0`
...
| Discoverable Phase 1 strategy, environment qualification, exact assurance Review, and source-independent pilot verification | 55, 57–58 | #45, #65 | `test/req-product-assurance-pilot.test.ts` |
