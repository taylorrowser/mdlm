...
- **Implementation package:** `mdlm-bootstrap@0.44.0`
...
| Discoverable Phase 1 strategy, environment qualification, exact assurance Review, autonomous same-lineage Review correction, separately authorized pilot implementation, and exact-target pilot evidence | 55, 57–58 | #45, #65–#66, #74 | `test/req-product-assurance-pilot.test.ts` |
