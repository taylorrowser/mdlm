...
| Authorized preparation, atomic Assignment Response submission, provenance, and authority-only Scenario publication | 43–47, 57–60 | #41–#43, #71, #87 | `test/req-scenario-dry-run.test.ts`, `test/mdlm-assignment.test.ts`, `test/req-consequential-authorization.test.ts` |
