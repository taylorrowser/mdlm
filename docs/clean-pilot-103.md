...
| Authoritative bounded gate | `npm test` passes package/evaluator contracts and representative compiled-public transactions within the exact 2,000,000 ms deadline |
