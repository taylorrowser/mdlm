...
| Authoritative bounded gate | `npm test` passes package/evaluator contracts and representative compiled-public transactions within the exact 1,150,000 ms deadline |
