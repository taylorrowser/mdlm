...
export function renderRootTestObservationInventory(root = process.cwd()) {
  ...
  lines.push(
    ...
    "- Internal synchronization, the test-owned timeout-cleanup proof, domain payload, and the exact 1,150,000 ms authoritative wrapper deadline are not child-process options or Vitest observation limits. Only the test-owned cleanup proof changed.",
    "",
  );
  return lines.join("\n");
}
