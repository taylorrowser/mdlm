...
const CONTENDED_ASSIGNMENT_RACE_TIMEOUT_MS = PROCESS_REPOSITORY_TEST_TIMEOUT_MS;
const CONTENDED_ASSIGNMENT_TEST_TIMEOUT_MS = PROCESS_REPOSITORY_TEST_TIMEOUT_MS;
