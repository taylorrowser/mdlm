...
- After Lesson 4, the learner correctly distinguished progression from Obligation satisfaction and located Scenario input contracts and Obligation bindings. Next teach Resolver pair authoring, then expression parsing and evaluation, then the generic kernel versus package-specific semantics boundary.
