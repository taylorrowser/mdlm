...
# Revise a failed gate sign-off Decision

Read `skills/lifecycle-data.md@1`, `skills/gate-protocol.md@1`, the complete
exact Decision lineage and failed Review/finding history, and the exact candidate.
