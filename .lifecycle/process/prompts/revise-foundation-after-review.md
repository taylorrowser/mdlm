...
simplification Review, reviewed gate rejection, or reviewed product-answer
Decision, including all structured findings, affected product Questions, and
frozen Review Contexts.
...
`corrects-gate-rejection` to every supplied rejection, and `incorporates-answer`
