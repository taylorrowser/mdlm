...
# Revise a failed Phase 0 foundation datum

Read `skills/lifecycle-data.md@1`, and, for a requirement, read
`skills/requirement-writing.md@1`. Use the exact subject and every supplied exact
failed Review, including all blocking Review Findings and each frozen Review
Context.
