...
cites every supplied failed Review through `corrects-review`, plus one exact scope
DEC whose `effective_scope` and `justifies` link name the replacement. Preserve
