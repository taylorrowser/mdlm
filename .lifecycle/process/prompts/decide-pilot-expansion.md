...
Stop until the stakeholder explicitly authorizes the exact recommendation; after
that authorization, the operating agent executes with `--authorize stakeholder`.
The DEC, not the conversation or completion summary, is the durable authorization.
