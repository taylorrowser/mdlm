...
Stop until the stakeholder explicitly authorizes the exact recommendation. Keep
that authority outside the Assignment Response, then submit through
`mdlm scenario submit [response-file|-] --authority stakeholder --json`. The
DEC, not the conversation or completion summary, is the durable authorization.
