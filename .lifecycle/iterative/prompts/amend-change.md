...
Preserve every previously approved `new_roots` statement exactly. Add distinct statements only for additional stakeholder roots; retain existing baseline targets as required. Publish and approve the amended CHG before using its expanded scope. Already admitted roots keep their identity through review-driven corrections.
