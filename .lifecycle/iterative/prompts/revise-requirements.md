...
To expand an accepted component into the agreed whole product, obtain a change targeting its stakeholder scope, revise that scope, and add necessary children through the affected decomposition group. Preserve exact scoring or other obligations whose meaning is unchanged. New requirements may use optional `informed-by` EXP/OBS links just as initial requirements do.
