...
export const rootTestManifest = [
  ...
  { file: "test/initial-product-intent-resolution.test.ts", runtimeClass: "process-repository-safe", weight: 2, measuredDurationMs: 36_894 },
  { file: "test/initial-product-intent-route.test.ts", runtimeClass: "process-repository-safe", weight: 2, measuredDurationMs: 46_607 },
  { file: "test/load-scenario-participation.test.ts", runtimeClass: "canonical-evaluator-safe", weight: 1, measuredDurationMs: 70_789 },
  { file: "test/mdlm-assignment-state.test.ts", runtimeClass: "process-repository-safe", weight: 2, measuredDurationMs: 57_581 },
  { file: "test/mdlm-clean-onboarding-transaction.test.ts", runtimeClass: "process-repository-safe", weight: 2, measuredDurationMs: 58_206 },
  { file: "test/mdlm-clean-pilot-contract.test.ts", runtimeClass: "repository-public-fragile", weight: 2, measuredDurationMs: 28_026 },
  { file: "test/mdlm-command-application.test.ts", runtimeClass: "process-repository-safe", weight: 2, measuredDurationMs: 63_686 },
  { file: "test/mdlm-init.test.ts", runtimeClass: "process-repository-safe", weight: 2, measuredDurationMs: 55_478 },
  { file: "test/mdlm-lifecycle.test.ts", runtimeClass: "repository-public-fragile", weight: 2, measuredDurationMs: 30_161 },
  { file: "test/mdlm-pilot-assessment.test.ts", runtimeClass: "process-repository-safe", weight: 2, measuredDurationMs: 15_950 },
  { file: "test/mdlm-process-expression.test.ts", runtimeClass: "process-repository-safe", weight: 2, measuredDurationMs: 47_352 },
  { file: "test/mdlm-process-migration.test.ts", runtimeClass: "repository-public-fragile", weight: 2, measuredDurationMs: 47_070 },
  { file: "test/mdlm-repository-inspection.test.ts", runtimeClass: "process-repository-safe", weight: 2, measuredDurationMs: 25_853 },
  { file: "test/mdlm-review-assignment.test.ts", runtimeClass: "repository-public-fragile", weight: 2, measuredDurationMs: 43_815 },
  { file: "test/mdlm-schema.test.ts", runtimeClass: "process-repository-safe", weight: 2, measuredDurationMs: 33_817 },
  { file: "test/operator-outcome.test.ts", runtimeClass: "process-repository-safe", weight: 2, measuredDurationMs: 51_114 },
  { file: "test/phase-0-corrected-gate-route.test.ts", runtimeClass: "process-repository-safe", weight: 2, measuredDurationMs: 85_291 },
  { file: "test/phase-0-hardening-routes.test.ts", runtimeClass: "canonical-fixture-filler", weight: 1, measuredDurationMs: 8_157 },
  { file: "test/phase-0-intent-candidate-currentness-route.test.ts", runtimeClass: "process-repository-safe", weight: 2, measuredDurationMs: 72_074 },
  { file: "test/phase-1-hardening-routes.test.ts", runtimeClass: "process-repository-safe", weight: 2, measuredDurationMs: 101_498 },
  { file: "test/phase-2-hardening-routes.test.ts", runtimeClass: "process-repository-safe", weight: 2, measuredDurationMs: 59_745 },
  { file: "test/proportional-phase-2-public.test.ts", runtimeClass: "canonical-fixture-filler", weight: 1, measuredDurationMs: 2_378 },
  { file: "test/selected-package-cache.test.ts", runtimeClass: "process-repository-safe", weight: 2, measuredDurationMs: 29_228 },
