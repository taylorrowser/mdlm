...
export const rootTestQualificationManifest = Object.freeze([
  { file: "test/direct-proposal-public.test.ts", qualificationGate: "release" },
  { file: "test/exploratory-process-journey.test.ts", qualificationGate: "release" },
  ...
  { file: "test/requirement-trace-v2.test.ts", qualificationGate: "pr" },
  { file: "test/change-assessment.test.ts", qualificationGate: "pr" },
  { file: "test/change-control-public.test.ts", qualificationGate: "pr" },
