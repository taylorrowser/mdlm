...
export const rootTestQualificationManifest = Object.freeze([
  ...
  { file: "test/phase-2-system-pilot-route.test.ts", qualificationGate: "pr" },
...
const rootTestRuntimeManifest = [
  ...
  { file: "test/phase-2-system-pilot-route.test.ts", runtimeClass: "cheap-in-process", weight: 1, measuredDurationMs: 2_000 },
