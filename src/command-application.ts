...
/**
 * Dispatch and render one MDLM command without owning process startup or
 * lifecycle. Executable adapters can therefore share the complete command
 * contract while deciding only how arguments, output, and exit status cross
 * their host boundary.
 */
